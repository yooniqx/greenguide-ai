...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GreenGuide AI — Smarter Choices for a Greener Tomorrow" },
      {
        name: "description",
        content:
          "GreenGuide AI helps you make eco-friendly choices with AI-powered sustainability insights, image analysis, and a personalized eco dashboard.",
      },
      { property: "og:title", content: "GreenGuide AI — Smarter Choices for a Greener Tomorrow" },
      {
        property: "og:description",
        content:
          "AI-powered sustainability companion: chat, image analysis, daily challenges, and eco insights.",
      },
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    // Always start at the top on fresh load / refresh. Prevents the browser
    // or any in-page effect from restoring a previous scroll position.
